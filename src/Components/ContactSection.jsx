    ...
    return <section id="contact" className="py-24 px-4 relative bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Thank you for your interest in my work. If you wish to contact me, you can reach me on email at
                manuelpepe1995@gmail.com or through my social media handles.
            </p>
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:manuelpepe1995@gmail.com"
                                   className="text-muted-foreground hover:text-primary transition-colors">
                                    manuelpepe1995@gmail.com
                                </a>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
